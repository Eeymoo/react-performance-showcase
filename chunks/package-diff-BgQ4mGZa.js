import{y as u,C as b,E as g,B as e,F as j,G as C,H as w}from"./vendor-react-CTURZAkq.js";import{n as h}from"./@vendor-emotion-h398TVVv.js";import{S as x,a as N}from"./vendor-antd-DJ0BsdNJ.js";import"./vendor-react-dom-CVPC-BA4.js";import"./vendor-antd-icons-BMchXmwU.js";const M=h.span`
  color: #333;
  border-radius: 4px;
  padding: 0 2px;
  font-size: 14px;
...
`,f=o=>{const{diffType:r="char",diffMode:s="current",historyContent:l="",currentContent:c,toArray:t=n=>n.split(`
`)}=o,[m,y]=u.useState([]);return u.useEffect(()=>{let n=g,i=[];if(r==="array"){const a=t(l||""),d=t(c||"");i=b(a,d)}r==="word"?n=j:r==="line"?n=C:r==="sentence"?n=w:r==="char"&&(n=g),s==="history"?i=[{value:l,added:!1,removed:!1,count:l.length}]:s==="current"?i=[{value:c,added:!1,removed:!1,count:c.length}]:r!=="array"&&(i=n(l,c)),y(i||[])},[l,c,r,s,t]),e.jsx("div",{className:"diff-container",children:e.jsx("div",{className:"diff-content",children:m?.map((n,i)=>{let a=M,d=n.value||"",p="diff-normal";if(n.added)a=D,p="diff-added";else if(n.removed)a=O,p="diff-removed";else if(s==="abridge"&&!n.added&&!n.removed&&d.length>20){a=A;const v=d.slice(0,10),S=d.slice(-10);d=`${v} ... ${S}`,p="diff-abridge"}return e.jsx(a,{className:p,children:d},`${n.value}-${i}`)})})})};function I(){const[o,r]=u.useState("word"),[s,l]=u.useState("compare"),c=u.useMemo(()=>t=>{if(typeof t!="string")return[];if(typeof Intl<"u"&&Intl.Segmenter)try{const i=new Intl.Segmenter("zh",{granularity:"word"}).segment(t);return Array.from(i).map(a=>a.segment)}catch(n){console.warn("系统分词失败，使用标点分词:",n)}const m="、。，！？；：“”‘’（）【】《》…—「」",y=new RegExp(`([${m}])|(
)|( )`,"g");return t.split(y).filter(n=>n&&n.trim())},[]);return e.jsxs("div",{children:[e.jsxs("div",{className:"mb-4",children:[e.jsx("span",{className:"mr-2",children:"Diff Type:"}),e.jsx(x,{options:[{label:"Word",value:"word"},{label:"Line",value:"line"},{label:"Sentence",value:"sentence"},{label:"Char",value:"char"},{label:"Array",value:"array"}],value:o,onChange:t=>r(t)})]}),e.jsxs("div",{className:"mb-4",children:[e.jsx("span",{className:"mr-2",children:"Diff Mode:"}),e.jsx(x,{options:[{label:"History",value:"history"},{label:"Current",value:"current"},{label:"Compare",value:"compare"},{label:"Abridge",value:"abridge"}],value:s,onChange:t=>l(t)})]}),e.jsxs(N,{direction:"vertical",style:{width:"100%"},size:24,children:[e.jsxs("div",{children:[e.jsx("span",{className:"mb-4",children:"中文示例:"}),e.jsx(f,{diffType:o,diffMode:s,historyContent:`《量子回声》讲述2085年科学家林薇研发出跨维度通信装置"量子铃"，却意外接收到平行宇宙的求救信号。
