import{y as c,C as M,J as N,B as e,L as T,N as k,P as E}from"./vendor-react-kWdcj25T.js";import{n as j}from"./@vendor-emotion-DXKo8qI6.js";import{a as w,B as D,I as A,S as K}from"./vendor-antd-Cs5o8GY6.js";import"./vendor-react-dom-BP3S_nvK.js";import"./vendor-antd-icons-wBpDmQ8_.js";const I=j.span`
  color: #333;
  border-radius: 4px;
  padding: 0 2px;
  font-size: 14px;
...
`,p=h=>{const{diffType:u="char",diffMode:o="current",historyContent:f="",currentContent:r,threshold:v=.85,toArray:g=t=>t.split(`
`)}=h,[b,x]=c.useState([]),C=c.useCallback((t,a=.85)=>{const n=[];let s=0,d=0,l=0,m=0,y="",S="";if(t.length===0)return n;for(const i of t)i.added?(d+=i.count||0,S+=i.value||""):i.removed?(l+=i.count||0,y+=i.value||""):(m+=i.count||0,y+=i.value||"",S+=i.value||""),s+=i.count||0;return m===0||(d+l)/s>=a||m/s<=1-a?(n.push({value:y,added:!1,removed:!0,count:y.length}),n.push({value:S,added:!0,removed:!1,count:S.length}),n):t},[]);return c.useEffect(()=>{let t=N,a=[];if(u==="array"){const n=g(f||""),s=g(r||"");a=M(n,s)}u==="word"?t=T:u==="line"?t=k:u==="sentence"?t=E:u==="char"&&(t=N),o==="history"?a=[{value:f,added:!1,removed:!1,count:f.length}]:o==="current"?a=[{value:r,added:!1,removed:!1,count:r.length}]:u!=="array"&&(a=t(f,r)),a=C(a,v),x(a||[])},[f,r,u,o,g,v]),e.jsx("div",{className:"diff-container",children:e.jsx("div",{className:"diff-content",children:b?.map((t,a)=>{let n=I,s=t.value||"",d="diff-normal";if(t.added)n=z,d="diff-added";else if(t.removed)n=G,d="diff-removed";else if(o==="abridge"&&!t.added&&!t.removed&&s.length>20){n=O;const l=s.slice(0,10),m=s.slice(-10);s=`${l} ... ${m}`,d="diff-abridge"}return e.jsx(n,{className:d,children:s},`${t.value}-${a}`)})})})};function V(){const[h,u]=c.useState("word"),[o,f]=c.useState("compare"),[r,v]=c.useState(.85),[g,b]=c.useState(""),[x,C]=c.useState(""),t=c.useMemo(()=>[{historyContent:"你好，世界！今天天气真好。",currentContent:"你好，小明！明天天气挺好的。"},{historyContent:`《量子回声》讲述2085年科学家林薇研发出跨维度通信装置"量子铃"，却意外接收到平行宇宙的求救信号。
...
《红楼梦》是一部具有世界影响力的人情小说、中国封建社会的百科全书、传统文化的集大成者、中国古代小说巅峰之作、中国古典四大名著之首。其作者以“大旨谈情，实录其事”自勉，只按自己的事体情理，按迹循踪，摆脱旧套，新鲜别致，取得了非凡的艺术成就。“真事隐去，假语存焉”的特殊笔法更是令后世读者脑洞大开，揣测之说久而遂多。二十世纪以来，《红楼梦》更以其丰富深刻的思想底蕴和异常出色的艺术成就使学术界产生了以其为研究对象的专门学问——红学。 [3]`}],[]),a=c.useMemo(()=>n=>{if(typeof n!="string")return[];if(typeof Intl<"u"&&Intl.Segmenter)try{const m=new Intl.Segmenter("zh",{granularity:"word"}).segment(n);return Array.from(m).map(y=>y.segment)}catch(l){console.warn("系统分词失败，使用标点分词:",l)}const s="、。，！？；：“”‘’（）【】《》…—「」",d=new RegExp(`([${s}])|(
)|( )`,"g");return n.split(d).filter(l=>l&&l.trim())},[]);return e.jsxs("div",{children:[e.jsxs("div",{className:"mb-4",children:[e.jsx("span",{className:"mr-2",children:"Diff Type:"}),e.jsx(w,{options:[{label:"Word",value:"word"},{label:"Line",value:"line"},{label:"Sentence",value:"sentence"},{label:"Char",value:"char"},{label:"Array",value:"array"}],value:h,onChange:n=>u(n)})]}),e.jsxs("div",{className:"mb-4",children:[e.jsx("span",{className:"mr-2",children:"Diff Mode:"}),e.jsx(w,{options:[{label:"History",value:"history"},{label:"Current",value:"current"},{label:"Compare",value:"compare"},{label:"Abridge",value:"abridge"}],value:o,onChange:n=>f(n)})]}),e.jsxs("div",{className:"mb-4",children:[e.jsx("span",{className:"mr-2",children:"Diff Threshold:"}),e.jsx(w,{options:[{label:"0.1",value:.1},{label:"0.15",value:.15},{label:"0.2",value:.2},{label:"0.25",value:.25},{label:"0.3",value:.3},{label:"0.35",value:.35},{label:"0.4",value:.4},{label:"0.45",value:.45},{label:"0.5",value:.5},{label:"0.55",value:.55},{label:"0.6",value:.6},{label:"0.65",value:.65},{label:"0.7",value:.7},{label:"0.75",value:.75},{label:"0.8",value:.8},{label:"0.85",value:.85},{label:"0.9",value:.9},{label:"0.95",value:.95},{label:"1.0",value:1}],value:r,onChange:n=>v(n)})]}),e.jsxs("div",{className:"mb-4 p-4 border border-gray-300 rounded-lg bg-gray-100",children:[e.jsx("div",{className:"flex gap-2 mb-4",children:t.map((n,s)=>e.jsxs(D,{onClick:()=>{b(n.historyContent),C(n.currentContent)},children:["示例 ",s+1]},s))}),e.jsxs("div",{className:"flex gap-4 mb-4",children:[e.jsx("div",{className:"w-1/2",children:e.jsx(A.TextArea,{autoSize:{minRows:4,maxRows:1/0},style:{height:"100%"},value:g,onChange:n=>b(n.target.value)})}),e.jsx("div",{className:"w-1/2",children:e.jsx(A.TextArea,{autoSize:{minRows:4,maxRows:1/0},style:{height:"100%"},value:x,onChange:n=>C(n.target.value)})})]}),e.jsx("div",{className:"bg-white p-4 rounded-lg",children:e.jsx(p,{diffType:h,diffMode:o,historyContent:g,currentContent:x,toArray:a,threshold:r})})]}),e.jsxs(K,{direction:"vertical",style:{width:"100%"},size:24,children:[e.jsxs("div",{children:[e.jsx("span",{className:"mb-4",children:"中文示例:"}),e.jsx(p,{diffType:h,diffMode:o,historyContent:`《量子回声》讲述2085年科学家林薇研发出跨维度通信装置"量子铃"，却意外接收到平行宇宙的求救信号。
当团队解码信号时，发现所有平行世界的文明都面临同种量子病毒威胁。
人类必须与镜像宇宙的自己合作，在72小时内破解病毒源码防止现实崩塌。`,currentContent:`《量子回声》聚焦2085年科学家林薇发明的跨维度设备"量子铃"，该装置意外捕获平行宇宙的濒危信号。
研究团队破译后发现所有平行世界遭受同种量子病毒侵袭。
书中核心冲突在于人类必须与平行自我联手，在三天内破解病毒编码阻止现实维度瓦解。`,threshold:r})]}),e.jsxs("div",{children:[e.jsx("span",{className:"mb-4",children:"英文示例:"}),e.jsx(p,{diffType:h,diffMode:o,historyContent:`"Neural Frontier" depicts neuro-engineer Kael's creation of a dream-sharing network that accidentally releases repressed collective trauma. As nightmares manifest physically across London, Kael must enter the collective subconscious with his prototype "Cortex Key" device to confront the entity absorbing human hope before consciousness collapses.`,currentContent:'"Neural Frontier" follows neuro-engineer Kael whose dream-sharing technology triggers the materialization of buried collective trauma. When nightmares physically erupt in London, Kael deploys his experimental "Cortex Key" to journey into the shared subconscious and stop an entity consuming human optimism before global consciousness fails.',threshold:r})]}),e.jsxs("div",{children:[e.jsx("span",{className:"mb-4",children:"混合示例:"}),e.jsx(p,{diffType:h,diffMode:o,historyContent:`当Tokyo的neural-network系统遭quantum-level病毒入侵，《意识边境》的AI伦理官Yumi发现这源于人类恐惧的具象化。
她必须用尚未验证的quantum-entanglement协议进入数字collective unconscious，在防火墙collapse前消除源头entity。`,currentContent:`《意识边境》危机始于Tokyo的neural-network被量子级病毒渗透，AI伦理官Yumi溯源发现是人类集体恐惧的manifestation。
剧情高潮在于她必须采用未经测试的quantum-entanglement技术闯入digital collective unconscious，赶在security-matrix崩溃前清除寄生entity的核心代码。`,threshold:r})]}),e.jsxs("div",{children:[e.jsx("span",{className:"mb-4",children:"中文示例:"}),e.jsx(p,{diffType:h,diffMode:o,historyContent:"你好，世界！今天天气真好。",currentContent:"你好，小明！明天天气挺好的。",threshold:r})]}),e.jsxs("div",{children:[e.jsx("span",{className:"mb-4",children:"浏览器中文分词处理示例:"}),e.jsx(p,{diffType:"array",diffMode:o,toArray:a,historyContent:"你好，世界！今天天气真好。",currentContent:"你好，小明！明天天气挺好的。",threshold:r})]}),e.jsxs("div",{children:[e.jsx("span",{className:"mb-4",children:"中文大文本示例:"}),e.jsx(p,{diffMode:o,historyContent:`
...
`,threshold:r})]})]})]})}export{V as default};
